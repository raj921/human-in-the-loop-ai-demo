...
export const VoicePoweredOrb: FC<VoicePoweredOrbProps> = ({
  ...
  const analyzeAudio = () => {
    if (!analyserRef.current || dataArrayRef.current.length === 0) return 0;
    // @ts-ignore - TypeScript Uint8Array type issue with Web Audio API
  ...
  useEffect(() => {
    ...
    try {
      rendererInstance = new Renderer({ alpha: true, antialias: true });
  ...
  }, [hue, enableVoiceControl, maxRotationSpeed, maxHoverIntensity]);
